<%@ Page Title="Final Grade Calculator" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="~/Exercise3.aspx.cs"  Inherits="Module1Exercise1.Exercise3" %>
...
<asp:Content ID="Exercise3Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Button Text="Calculate" runat="server" OnClick="CalculateGrade_Click" />
    <br />
    <br />
